    ...
    <div>
      ...
      <main>
        ...
        <p className="description">
          Click the button below, and view the sample error on the Sentry <a target="_blank" href="https://itp-be.sentry.io/issues/?project=4509449520742400">Issues Page</a>.
